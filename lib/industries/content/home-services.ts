...
export const homeServicesVertical: IndustryVertical = {
  ...
  problemsIntro:
    "None of these problems are about the quality of your work. They are operational leaks that add up across the season.",
  problems: [
    {
      id: "missed-calls",
  ...
  workflow: {
    title: "The Leadtocollectedjob Workflow",
    intro:
  ...
  ctas: {
    ...
    secondary: [
      { label: "Analyze My Leadtojob Workflow", href: "#workflow" },
