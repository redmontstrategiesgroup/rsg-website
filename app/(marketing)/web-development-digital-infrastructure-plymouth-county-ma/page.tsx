...
const content: LocalPageContent = {
  slug: "web-development-digital-infrastructure-plymouth-county-ma",
  ...
  serviceArea:
    "RSG builds websites and digital infrastructure for service businesses across Plymouth County and the South Shore of Massachusetts, including Plymouth, Carver, and Wareham.",
  faqs: [
    {
