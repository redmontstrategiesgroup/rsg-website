...
const content: LocalPageContent = {
  slug: "business-consulting-plymouth-county-ma",
  ...
  serviceArea:
    "RSG works with service businesses across Plymouth County and the South Shore of Massachusetts, including Plymouth, Pembroke, and Hingham.",
  faqs: [
    {
