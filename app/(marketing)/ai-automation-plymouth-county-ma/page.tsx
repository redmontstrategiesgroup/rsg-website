...
const content: LocalPageContent = {
  slug: "ai-automation-plymouth-county-ma",
  ...
  serviceArea:
    "RSG builds AI automation for service businesses across Plymouth County and the South Shore of Massachusetts, including Bridgewater, Whitman, and Hanson.",
  faqs: [
    {
