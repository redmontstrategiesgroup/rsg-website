...
const content: LocalPageContent = {
  ...
  includes: [
    ...
    "Past-client and referral campaigns for real estate teams",
    "Automated review requests",
    "Property inquiry assistants that answer availability questions",
    "Contingency deadline alerts on transaction files",
    "CRM and pipeline automation",
    "Customer communication flows with human handoff",
    "Daily owner summaries for brokerages and agent teams",
  ],
  ...
  who: [
    ...
    "Brokerages and agent teams fielding the same property questions every day",
