...
const content: LocalPageContent = {
  slug: "crm-pipeline-systems-plymouth-county-ma",
  ...
  serviceArea:
    "RSG builds CRM and pipeline systems for service businesses across Plymouth County and the South Shore of Massachusetts, including Middleborough, Lakeville, and Bourne.",
  faqs: [
    {
