...
const content: LocalPageContent = {
  slug: "operationsconsulting",
  managedService: "operations_system",
  ...
  serviceArea:
    "RSG provides operations consulting to service businesses across Plymouth County and the South Shore of Massachusetts.",
  faqs: [
    {
